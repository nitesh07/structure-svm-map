...
int main (int argc, char* argv[])
{
    ...
    //memset(&sample,sizeof(SAMPLE),0);
    //memset(&learn_parm,sizeof(LEARN_PARM),0);
    //memset(&kernel_parm,sizeof(KERNEL_PARM),0);
    //memset(&struct_parm,sizeof(STRUCT_LEARN_PARM),0);
    //memset(&structmodel,sizeof(STRUCTMODEL),0);
